...
pub fn call_builtin(name: &str, args: Vec<Value>) -> Result<Value, String> {
    match name {
        ...
        // JSON support (from web.rs)
        "json-parse" => web::builtin_json_parse(args),
        "json-stringify" => web::builtin_json_stringify(args),
        // HTTP client (from web.rs)
        "http-get" => web::builtin_http_get(args),
        "http-post" => web::builtin_http_post(args),
